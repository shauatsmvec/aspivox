const Footer = () => (
  <footer style={{ backgroundColor: "#050505" }} className="py-20 border-t border-white/5">
      ...
      <div className="grid md:grid-cols-3 gap-12">
        ...
        <div>
          <div className="flex items-center gap-2 mb-6">
            ...
            <span className="text-xl font-bold text-white font-display uppercase tracking-tight">Aspivox</span>
          </div>
          <p className="text-gray-500 text-sm mb-4 font-light">Start Today — State Tomorrow</p>
          <p className="text-gray-600 text-xs tracking-wide">MSME Registered | © 2025 Aspivox. All rights reserved.</p>
        </div>
          ...
          <div className="space-y-3">
            {["Home", "Courses", "Internship", "About", "Contact"].map((link) => (
              <a
                ...
                className="block text-gray-500 hover:text-cyan transition-colors text-sm font-medium"
              >
                {link}
              </a>
            ))}
        ...
        {/* Social */}
        <div>
          <h4 className="text-white font-bold mb-6 font-display uppercase tracking-wider text-sm">Follow Us</h4>
          <div className="flex gap-4">
            <a href="https://www.linkedin.com/company/aspivox/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-white/5 border border-white/10 rounded-full flex items-center justify-center text-white hover:bg-violet hover:border-violet transition-all">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 01-2.063-2.065 2.064 2.064 0 112.063 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/></svg>
            </a>
            <a href="https://www.threads.net/@aspivox_edutech" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-white/5 border border-white/10 rounded-full flex items-center justify-center text-white hover:bg-violet hover:border-violet transition-all">
