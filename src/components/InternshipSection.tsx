...
const InternshipSection = () => {
  return (
    <section id="internship" className="py-24 lg:py-32 relative overflow-hidden bg-background">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          <h2 className="text-4xl sm:text-5xl font-bold font-display mb-4 text-foreground uppercase tracking-tight">
            <span className="text-cyan">Internship</span> Programs
          </h2>
        ...
        >
          {durations.map((d, i) => (
            <motion.div
              ...
              className="bg-card backdrop-blur-sm rounded-2xl px-10 py-8 border border-border hover:border-cyan/30 hover:bg-accent/50 transition-all text-center group shadow-xl"
            >
              <p className="text-4xl font-bold text-cyan group-hover:scale-110 transition-transform">{d.split(" ")[0]}</p>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          {highlights.map((h, i) => (
            ...
            >
              <div className="w-10 h-10 bg-cyan/10 rounded-xl flex items-center justify-center shrink-0">
